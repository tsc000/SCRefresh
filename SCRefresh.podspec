#
#  Be sure to run `pod spec lint SCRefresh.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "SCRefresh/Refresh/Refresh/Source/*.{h,m}"
  s.exclude_files = "Refresh/Refresh/Source"

  s.public_header_files = "SCRefresh/Refresh/Refresh/Source/*.h"
